...
static void hal_layer_csc_set_video_param(hal_disp_layer layer, csc_coef_param *coef_param)
{
...
static hi_void hal_layer_csc_set_gfx_param(hal_disp_layer layer, csc_coef_param *coef_param)
{
    U_V0_HIPP_CSC_SCALE V0_HIPP_CSC_SCALE;
    U_V0_HIPP_CSC_MIN_Y V0_HIPP_CSC_MIN_Y;
    U_V0_HIPP_CSC_MIN_C V0_HIPP_CSC_MIN_C;
