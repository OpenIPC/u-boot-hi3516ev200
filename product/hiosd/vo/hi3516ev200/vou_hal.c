...
static hi_void hal_disp_set_dither_sed0(hal_disp_outputchannel chan, hal_disp_dihter_sed *dither_sed)
{
...
static hi_void hal_disp_set_dither_sed1(hal_disp_outputchannel chan, hal_disp_dihter_sed *dither_sed)
{
...
static hi_void hal_disp_set_dither_sed2(hal_disp_outputchannel chan, hal_disp_dihter_sed *dither_sed)
{
...
static hi_void hal_disp_set_dither_sed3(hal_disp_outputchannel chan, hal_disp_dihter_sed *dither_sed)
{
