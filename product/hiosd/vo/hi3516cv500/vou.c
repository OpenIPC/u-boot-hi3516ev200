...
static hi_void video_layer_set_zme_cfg(unsigned int layer, rect *disp_rect)
{
...
static hi_void video_layer_set_csc_by_intf(unsigned int layer, vo_intf_type vo_intf_type)
{
    vo_layer vo_layer;
...
int start_videolayer(unsigned int layer, unsigned long addr, unsigned int strd, hi_vo_rect layer_rect)
{
    ...
    video_layer_set_csc_by_intf(layer, vo_intf_type);
...
static hi_void gfx_layer_set_csc_by_intf(unsigned int layer, vo_intf_type vo_intf_type)
{
    vo_layer vo_layer;
    hal_disp_layer hal_gfx_layer;
    vo_csc gfx_csc;
...
int start_gx(unsigned int layer, unsigned long addr, unsigned int strd, hi_vo_rect gx_rect)
{
    ...
    gfx_layer_set_csc_by_intf(layer, vo_intf_type);
