...
static hi_void hal_disp_set_dither_sed0(hal_disp_outputchannel chn, hal_disp_dihter_sed *dither_sed)
{
...
static hi_void hal_disp_set_dither_sed1(hal_disp_outputchannel chn, hal_disp_dihter_sed *dither_sed)
{
...
static hi_void hal_disp_set_dither_sed2(hal_disp_outputchannel chn, hal_disp_dihter_sed *dither_sed)
{
...
static hi_void hal_disp_set_dither_sed3(hal_disp_outputchannel chn, hal_disp_dihter_sed *dither_sed)
{
...
hi_void hal_layer_csc_set_video_param(hal_disp_layer layer, csc_coef_param *coef_param)
{
...
hi_void hal_layer_csc_set_gfx_param(hal_disp_layer layer, csc_coef_param *coef_param)
{
    U_V0_HIPP_CSC_SCALE V0_HIPP_CSC_SCALE;
    U_V0_HIPP_CSC_MIN_Y V0_HIPP_CSC_MIN_Y;
    U_V0_HIPP_CSC_MIN_C V0_HIPP_CSC_MIN_C;
...
static hi_void hal_layer_csc_set_video_coef0x(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_video_coef1x(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_video_coef2x(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
...
static hi_void hal_layer_csc_set_gfx_coef0x(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
    U_V0_HIPP_CSC_COEF00 V0_HIPP_CSC_COEF00;
    U_V0_HIPP_CSC_COEF01 V0_HIPP_CSC_COEF01;
    U_V0_HIPP_CSC_COEF02 V0_HIPP_CSC_COEF02;
...
static hi_void hal_layer_csc_set_gfx_coef1x(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
    U_V0_HIPP_CSC_COEF10 V0_HIPP_CSC_COEF10;
    U_V0_HIPP_CSC_COEF11 V0_HIPP_CSC_COEF11;
    U_V0_HIPP_CSC_COEF12 V0_HIPP_CSC_COEF12;
...
static hi_void hal_layer_csc_set_gfx_coef2x(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
    U_V0_HIPP_CSC_COEF20 V0_HIPP_CSC_COEF20;
    U_V0_HIPP_CSC_COEF21 V0_HIPP_CSC_COEF21;
    U_V0_HIPP_CSC_COEF22 V0_HIPP_CSC_COEF22;
