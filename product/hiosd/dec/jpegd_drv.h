...
typedef struct {
    ...
    hi_u64 y_phy_addr;
    hi_u64 c_phy_addr;
    hi_u64 phy_str_buf_start;
    hi_u64 phy_str_buf_end;
    hi_u64 phy_str_start;
    hi_u64 phy_str_end;
    hi_u64 phy_emar_buffer0;
    hi_u64 phy_emar_buffer1;
...
void jpegd_drv_write_regs(void *reg_base, jpegd_vpu_config *vpu_config);

void jpegd_drv_read_regs(void *reg_base, jpegd_vpu_status *vpu_status);
