...
int decode_sof0(motion_jpeg_obj *mjpeg, const unsigned char *stream, unsigned int len);
int decode_sos(motion_jpeg_obj *mjpeg, unsigned char *stream, unsigned int len);
