...
HI_S32 HAL_Cipher_KladConfig(HI_U32 chnId, HI_U32 u32OptId, HI_UNF_CIPHER_KLAD_TARGET_E enTarget, HI_BOOL bIsDecrypt)
{
    ...
    u32Ctrl  = chnId << 16;
    u32Ctrl |= (HI_U32)enTarget << 2;   /* cipher klad */
    u32Ctrl |= (HI_U32)bIsDecrypt << 1; /* decrypt     */
    u32Ctrl |= 0x00;            /* start       */
                              ...
                              HI_U32 u32KeyLen)
{
    ...
    crypto_memset(u32Key, sizeof(u32Key), 0, sizeof(u32Key));
    ...
    {
        crypto_memcpy(u32Key, 16, pu8DataIn+i*16, 16);
