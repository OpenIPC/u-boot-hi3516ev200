...
HI_S32 DRV_CIPHER_CalcRsa(CIPHER_RSA_DATA_S *pCipherRsaData)
{
    ...
    crypto_memset(N, sizeof(N), 0, sizeof(N));
    crypto_memset(K, sizeof(K), 0, sizeof(K));
    crypto_memset(M, sizeof(M), 0, sizeof(M));
    ...
    crypto_memset(&stCipherRsaData, sizeof(stCipherRsaData), 0, sizeof(CIPHER_RSA_DATA_S));
